...
class TrackingServientregaController extends Controller
{
    ...
    {
        try {
            Log::info('🔄 Probando conversión alternativa');
            ...
            // Intentar con Intervention Image usando Imagick driver específicamente
            try {
                $manager = new \Intervention\Image\ImageManager([
                    'driver' => 'imagick'
                ]);

                $image = $manager->make($tiffBinario);
                ...
                // Convertir a PNG
                $pngData = $image->encode('png')->__toString();
                $pngBase64 = base64_encode($pngData);

                Log::info('✅ Conversión a PNG exitosa', [
                    'tamaño_png' => strlen($pngData),
                    'tamaño_base64' => strlen($pngBase64)
                ]);
            ...
            // Intentar con Imagick directamente
            try {
